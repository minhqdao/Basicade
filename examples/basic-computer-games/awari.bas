...
6 PRINT
7 PRINT TAB(15);"CREATIVE COMPUTING  MORRISTOWN, NEW JERSEY":PRINT
8 PRINT "AWARI IS A MANCALA GAME.  TOP ROW = COMPUTER, BOTTOM = YOU."
10 DATA 0
11 PRINT "EACH PIT STARTS WITH 3 STONES.  COMPUTER'S STORE IS LEFT,"
12 PRINT "YOURS IS RIGHT.  ENTER 1-6 TO PICK A PIT.  STONES ARE DROPPED"
13 PRINT "ONE AT A TIME COUNTER-CLOCKWISE.  THEY PASS THROUGH BOTH"
14 PRINT "STORES AND KEEP GOING AROUND THE BOARD.  IF YOUR LAST STONE"
15 DIM B(13),G(13),F(50):READ N
16 PRINT "LANDS IN YOUR STORE, YOU MOVE AGAIN.  IF IT LANDS IN AN EMPTY"
17 PRINT "PIT AND THE OPPOSITE PIT HAS STONES, YOU CAPTURE BOTH."
18 PRINT "WHEN EITHER SIDE HAS NO STONES, THE GAME ENDS.  THE PLAYER"
19 PRINT "WITH THE MOST STONES IN STORE WINS."
20 PRINT:PRINT:E=0
...
140 H=6:GOSUB 200
150 GOSUB 500:RETURN
200 K=M:GOSUB 600
205 E=0:IF K>6 THEN K=K-7
210 C=C+1:IF C<9 THEN F(N)=F(N)*6+K
215 S=0
216 FOR I=0 TO 5
217 IF B(I)<>0 THEN S=1
220 NEXT I
225 IF S=0 THEN RETURN
230 FOR I=7 TO 12
232 IF B(I)<>0 THEN E=1
235 NEXT I
240 RETURN
500 PRINT:PRINT"   ";
...
885 NEXT J
890 M=A:PRINT CHR$(42+M);:GOSUB 200:RETURN
