...
16 PRINT "LANDS IN YOUR EMPTY PIT AND THE OPPOSITE PIT HAS STONES,"
17 PRINT "YOU CAPTURE BOTH.  WHEN EITHER SIDE HAS NO STONES,"
18 PRINT "THE GAME ENDS.  THE PLAYER WITH THE MOST STONES IN STORE WINS."
20 PRINT:PRINT:E=0
