...
160 IF MID$(B$(X%),Y%,1)<>" " THEN A%(X1%+XX%,Y1%+YY%)=1:P%=P%+1
170 NEXT Y%
180 NEXT X%
...
240 PRINT
250 FOR Y%=Y1% TO Y2%
253 IF AX(X%,Y%)=2% THEN A%(X%,Y%)=0%:GO TO 270
256 IF AX(X%,Y%)=3% THEN A%(X%,Y%)=1:GO TO 261
260 IF AX(X%,Y%)<>1 THEN 270
261 PRINT TAB(Y%);"*";
...
550 IF A%(I%,J%)=1% OR AX(I%,J%)=2% THEN C%=C%+1%
560 NEXT J%
570 NEXT I%
580 IF AX(X%,Y%)=0% THEN 610
