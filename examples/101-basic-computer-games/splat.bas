...
40 DIM #1%,A(4000)
55 RANDOMIZE
95 PRINT "WELCOME TO ISPLAT! -- THE GAME THAT SIMULATES A PARACHUTE"
...
119 PRINT "S ELECT YOUR OWN TERMINAL VELOCITY (YES OR NO)";\INPUT A1$
...
151 PRINT "FINE, YOU'RE ON MERCURY. ACCELERATION=12.2FT/SEC/SEC"\GOTO 161
