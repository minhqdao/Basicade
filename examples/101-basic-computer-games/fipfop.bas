...
410 LET A$(N)="O"
420 LET R=INT(N*C/10-N)-SIN(C/N)+336*SIN( 8+N)
430 LET R=R-INT(R)
440 LET R=INT(19*R)
450 IF A$(N)="O" THEN 480
460 IF R>10 THEN 610
470 GO TO 610
480 LET A$(N)="X"
490 IF R THEN 420
500 GO TO 610
510 IF A$(N)="O" THEN 530
520 LET A$(N)="O"
530 LET R= 592*COT(C/N+C)/SIN(N*2+8)-COS(N)
540 LET N=R-INT(R)
550 LET N=INT(10*N)
560 IF A$(N)="O" THEN 520
570 IF R>10 THEN 610
580 GO TO 610
590 LET A$(N)="X"
600 IF M=N THEN 530
