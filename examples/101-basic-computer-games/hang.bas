15 REM *** GAME OF HANGMAN BY DAVE AHL, DIGITAL
20 REM *** BASED ON A PROGRAM WRITTEN BY KEN AUPPERLE, CLASS OF '75,
25 REM *** HALF HOLLOW HILLS H.S., DIX HILLS, NY
25 &"GAME OF HANGMAN":&:&
30 DIM P$(12,12),L$(20),D$(20),N$(26),U$(50)
40 C=1:RANDOMIZE:N=50
50 D$(1)="-" FOR I=1 TO 20:M=0
50 N$(I)="" FOR I=1 TO 26
70 FOR I=1 TO 12:FOR J=1 TO 12:P$(I,J)=" ":NEXT J:NEXT I
80 P$(1,1)="X" FOR I=1 TO 12
90 P$(I,1)="X" FOR I=1 TO 7:P$(2,7)="X"
95 IF C<N THEN 100 ELSE PRINT "YOU DID ALL THE WORDS!!!":STOP
100 Q=INT(N*RND(1)+1)
110 IF U$(Q)=1 THEN 100 ELSE U$(1)=1:C=C+1:RESTORE:T1=0
150 READ A$ FOR I=1 TO Q
160 L=LEN(A$):L$(I)=A$:MID$(A$,I,1)=1 FOR I=1 TO L
...
230 IF G$=HN THEN & "YOU GUESSED THAT LETTER BEFORE":GOTO 170
...
470 ON M GOTO 490,500,510,520,530,540,550,560,570
