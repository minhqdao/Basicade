...
101 REM REVISED 8/18/78 (D. PESSEL, L. BRAUN, C. LOSIK)
102 REM IMP VRBLS: A=MRKT TRND SLP, B$=BRKRGE FEE: C=TTL CSM ASST$
103 REM C5=TTL CSM ASST$ (TEMP), C(I)=CHNG IN STK VAL: D=TTL ASST$
104 REM E1,E2=LRG CHNG MISC: I=STOCK #: I1,I2=STCK$ W LRG CHNG:
105 REM N1,N2=LRG CHNG DAY CNT$: P$=TTL DAYS PRCH$S: P(I)=PRTFL CNTNT$
106 REM Q9=NEW CYCLE?: S$=SGN OF A: S$=TTL DYS SL$: S(I)=VALUE/SHR:
107 REM T=TTL STCK ASST$: T$=TTL VAL OF TRNSCTN$:
108 REM W$=LRG CHNG: X1=SMLL CHNG (<$1): Z4,Z5,Z6=NYSE AVE.: Z(I)=TRNSCTN.
...
358  PRINT "CENSORED BOOKS STORE","  CBS",S(5)
360  PRINT
...
790  PRINT
810  GO TO 360
820 REM NEW STOCK VALUES - SUBROUTINE
