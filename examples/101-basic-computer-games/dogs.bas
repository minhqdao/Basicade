...
505 PRINT CHR$(135);CHR$(135);CHR$(135);CHR$(135);CHR$(135);CHR$(135);
510 FOR R=1 TO 10
515  RANDOMIZE
...
980 X=X+1\ PUT 9,30,I
985 GO TO   1000
990 V=V+1\PUT 8,25,I
1000 NEXT I
1005 GOTO 755
...
1030 IF Q4>20 THEN 1035\Q=Q4\Q4=0\GOTO 1040
