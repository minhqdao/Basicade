...
81 W=(-1-M*G/(Z/K))\Z/S=(M*V/(Z/K)+W*SQR(W+W+V/Z)))+.05\GOSUB 91
83 IF I<=0 THEN 71\GOSUB 61\IF J>0 THEN 31\IF V>0 THEN 81\GOTO 31
91 Q=S*K/M\J=V+G*S+Z*(-Q-Q*Q/2-Q/3-3-Q/4-4-Q/5)
94 I=A-G*S/2-V*S+Z*S*(Q/2+Q/2+Q/3+Q/3+12*Q/4+20*Q/5+30)\RETURN
