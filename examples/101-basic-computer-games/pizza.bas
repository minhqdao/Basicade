...
650 PRINT "YOUR ANSWER SHOULD BE 2,3":PRINT
...
790 INPUT A(1),A(2)
800 IF A(1)<>INT(A(1)) THEN 850
810 IF A(2)<>INT(A(2)) THEN 850
820 IF A(1)<1 THEN 850
830 IF A(1)>4 THEN 850
840 IF A(2)<1 THEN 850
845 IF A(2)>4 THEN 850
847 GOTO 870
850 PRINT "THOSE COORDINATES DON'T EXIST.  TRY AGAIN."
860 GOTO 780
870 T=A(1)+(A(2)-1)*4
880 IF T=S THEN 920
