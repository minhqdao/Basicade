...
920GOTO550
930PRINT"PLAYER NUMBER";Q;"IS ON THE GREEN (ENTER 9 FOR PUTTER)"
940INPUTX
950IFX<>9THENPRINT"USE CLUB 9 TO PUTT"
952IFX<>9THEN940
954LETD=X
960GOTO1310
970PRINT X(D) "PUTTS"
...
1120NEXT S
1130GOTO1440
1140LETX(2)=INT(71*RND(0)+150)
1150GOTO600
1160LETX(1)=INT(121*RND(0)+150)
1170GOTO600
1180LETX(3)=INT(41*RND(0)+140)
1190GOTO600
1200LETX(4)=INT(61*RND(0)+120)
1210GOTO600
1220LETX(5)=INT(31*RND(0)+100)
1230GOTO600
1240LETX(6)=INT(31*RND(0)+70)
1250GOTO600
1260LETX(7)=INT(41*RND(0)+30)
1270GOTO600
1280LETX(8)=INT(30*RND(0)+1)
1290IFX(8)<1THEN1280
1300GOTO600
1310LETX(9)=INT(3*RND(0)+1)
1320GOTO600
1330STOP
1340IFX=1THEN1160
1350IFX=2THEN1140
