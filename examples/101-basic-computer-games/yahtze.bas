...
1030 NEXT U
1040 CHANGE A TO C$
1060 DIMA(15,15),T(15,15),F(15,15),S(15,15),L(15,15),K(15,15),H(15,15)
1070 FOR I=1 TO 5
1080 B(I)=0
1090 Q(I)=0
1100 A(I)=0
...
5020 PRINT
5040 PRINT "YAHTZEE MAY BE PLAYED BY UP TO 15 PEOPLE."
5060 PRINT "THE OBJECT OF THE GAME IS TO GET THE HIGHEST SCORE"
5080 PRINT "EACH PLAYER ON HIS TURN RECEIVES FROM THE COMPUTER"
5100 PRINT "THE VALUES OF THE 5 PSEUDO-DICE. HE MAY THEN ROLL"
5120 PRINT "AS MANY OF THEM AS HE WANTS TO AGAIN. HOWEVER,"
5140 PRINT "HE IS ENTITLED UP TO BUT NO MORE THAN THREE ROLLS"
5160 PRINT "OF THE DICE."
5080 PRINT "     YOU TELL THE COMPUTER MANY DICE YOU"
5100 PRINT "WANT TO CHANGE, THEN TELL IT WHICH ONES IN THE FOL-"
5120 PRINT "LOWING MANNER:"
5130 PRINT
5140 PRINT " TYPE '1' FOR THE 1ST DIE, '2' FOR THE 2ND, ETC"
5160 PRINT "    AFTER THE THIRD ROLL THE PLAYER MUST DECIDE HOW"
5180 PRINT "HE WANTS TO SCORE HIS FIVE DICE."
5200 PRINT "TYPING 'SUMMARY' WILL SHOW WHAT CATEGORIES"
5220 PRINT "HAVE BEEN USED. OTHERWISE,"
5240 PRINT "YOU HAVE 13 CHOICES, TYPE 1 OF THE FOLLOWING"
5260 PRINT "DEPENDING ON HOW YOU WANT YOUR DICE SCORED."
5280 PRINT "THE CHOICES ARE:"
5300 PRINT "ACES,TWOS,THREES,FOURS,FIVES,SIXES"
5320 PRINT "THREE OF A KIND,FOUR OF A KIND,FULL HOUSE, SM. STRAIGHT,"
5340 PRINT "LG. STRAIGHT, YAHTZEE,CHANCE."
5260 PRINT "WHAT THE COMPUTER WILL DO:"
5280 PRINT "FOR ACES IT WILL COUNT AND ADD ALL OF YOUR ONES."
5300 PRINT "FOR TWOS IT WILL COUNT AND ADD ALL OF YOUR TWOS."
5320 PRINT "THE SAME IS TRUE THROUGH THE SIXES"
5340 PRINT "THREE OF A KIND WILL TOTAL ALL OF THE DICE PRO-"
5360 PRINT "VIDED THAT YOU HAVE THREE OF A KIND"
5380 PRINT "FOUR OF A KIND IS THE SAME AS THREE OF A KIND EXCEPT"
5400 PRINT "THAT YOU MUST HAVE FOUR OF A KIND"
5420 PRINT "FULL HOUSE (3 OF ONE NO. AND 2 OF ANOTHER) WILL YIELD"
5440 PRINT "25 POINTS. SM. STRAIGHT WILL GIVE YOU 30 POINTS BUT"
5460 PRINT "YOU MUST HAVE A SEQUENCE OF FOUR."
5480 PRINT "LG.STRAIGHT WILL YIELD 40 POINTS BUT YOU MUST HAVE A SE-"
5500 PRINT "QUENCE OF FIVE."
5520 PRINT "YAHTZEE WILL GIVE 50 POINTS IF YOU HAVE FIVE OF A KIND."
5540 PRINT "CHANCE WILL TOTAL ALL OF YOUR DICE AND USE THAT AS YOUR SCORE."
5560 PRINT "CHANCE IS USEFUL WHEN YOU DON'T HAVE ANYTHING WORTH SCORING."
5380 PRINT "ANOTHER CATEGORY, 'ZERO' WILL ZERO OUT A CATEGORY"
5400 PRINT "IF YOU DON'T HAVE ANYTHING WORTH SCORING."
5420 PRINT "BUT HAVE PERHAPS ALREADY USED YOUR CHANCE."
5440 PRINT
...
5590 PRINT "HOW MANY DICE DO YOU WANT TO ROLL AGAIN";
5610 RETURN
...
6170 ON H(I,S) GOTO 6190,6210,6230,6250,6270,6290,6310
6178 ON H(I,S)-7 GOTO 6330,6350,6370,6390,6410,6430
6190 PRINT "ACES, ";
6200 GOTO 6440
6210 PRINT "TWOS, ";
6220 GOTO 6440
...
6430 PRINT "CHANCE, ";
6440 NEXT S
6445 PRINT "HE HAS ";K(I);" POINTS,"
6446 PRINT "AND ";K(1,I);" OF THE 65 POINTS NEEDED FOR THE BONUS";
6447 PRINT "."
6450 PRINT
6460 RETURN
6470 G=0
...
6573 NEXT X
6580 PRINT "THE WINNER IS ";NS(1);" WITH ";K(1);" POINTS."
6585 IF P=1 THEN 9999
6586 PRINT "OTHER FINAL SCORES ARE:"
6590 FOR Y=1 TO P
6600 IF K(Y)=S(X) THEN 6620
6610 PRINT NS(Y);" FINISHES WITH ";K(Y);" POINTS."
6620 NEXT Y
9999 END