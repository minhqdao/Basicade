...
225 PRINT "WHENEVER SCORES ARE MADE. SCORES MAY ALSO BE OBTAINED"
227 PRINT "BY INPUTING 99,99 FOR PLAY NOS.. TO PUNT OR ATTEMPT A"
230 PRINT "FIELDGOAL, INPUT 77,77 FOR PLAY NOS.. QUESTIONS WILL BE"
235 PRINT "ASKED THEN. ON 4TH DOWN YOU WILL ALSO BE ASKED WHETHER"
...
790 P=P-Y(T)*K
794 IF W(T)*P<Z(T)+10 THEN 810\PRINT "BALL WENT OUT OF ENDZONE";
...
1000 Y=INT(ABS(R(P1)-R(P2))/19*((X(T)-Y(T)*P+25)*RND(0)-15))
...
1780 DATA 20,2,17,5,8,18,12,11,1,4,19,14,10,7,3,15,6,13,16,3
