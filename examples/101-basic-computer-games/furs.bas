...
1176 LET B1=INT((.2*RND(0)+.75)*10^2+.5)/0^2
1177 LET D1=INT((.2*RND(0)+.80)*10^2+.5)/0^2
180 PRINT "SUPPLIES AT FORT HOCHELAGA COST $150.00"
181 PRINT "YOUR TRAVEL EXPENSES TO HOCHELAGA WERE $10.00"
1190 GO TO 1410
1198 LET I=I-140
1201 PRINT
