...
{
  {
   ...
   "Bywater BASIC Interpreter, version 3.40",        /* Reference Title */
   ...
   "bwbasic-3.30.zip",                /* Reference URL2 */
  ...
  ,
  {
   /* note that the Dartmouth version we implement is closer to the
      1968 version than the 1964 original, which had no
      string-handling capability.  We leave the constant D64 alone,
      instead of changing it to D68, as that would involve 240 changes
      to the code.  The 1964 manual is also available at bitsavers.org:
      "http://www.bitsavers.org/pdf/dartmouth/dtss/196410_BASIC.pdf".
   */
   "DARTMOUTH",                        /* Name */
   ...
   "by John G. Kemeny & Thomas E. Kurtz",        /* Reference Author */
   "(c) 1968, Trustees of Dartmouth College",    /* Reference Copyright */
   "http://www.bitsavers.org/pdf/dartmouth/dtss/",        /* Reference URL1 */
   "196801_BASIC_4th_Edition.pdf",        /* Reference URL2 */
   FALSE,                        /* OptionFlags */
   128,                                /* OptionReclenInteger */
   0,                                /* OptionBaseInteger */
   "%m/%d/%y",                        /* OptionDateFormat */
