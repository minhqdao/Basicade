...
Run classic BASIC programs wherever JavaScript runs. `retrobasic-wasm` packages the [RetroBASIC](https://github.com/maurymarkowitz/RetroBASIC) interpreter as a zero-dependency, single-file WebAssembly bundle. Perfect for preserving vintage BASIC software and running retro text games like [The Oregon Trail](https://minhqdao.github.io/Basicade/oregon-trail/?interpreter=retrobasic), [Hammurabi](https://minhqdao.github.io/Basicade/bcg-hammurabi/?interpreter=retrobasic), [Lunar Lander](https://minhqdao.github.io/Basicade/bcg-lunar/?interpreter=retrobasic), and [Super Star Trek](https://minhqdao.github.io/Basicade/bcg-super-star-trek/?interpreter=retrobasic) directly in Node.js or modern browsers.
...
The repository includes an interactive browser demo running [The Oregon Trail](https://minhqdao.github.io/Basicade/oregon-trail/?interpreter=retrobasic), [Hammurabi](https://minhqdao.github.io/Basicade/bcg-hammurabi/?interpreter=retrobasic), [Lunar Lander](https://minhqdao.github.io/Basicade/bcg-lunar/?interpreter=retrobasic), and [Super Star Trek](https://minhqdao.github.io/Basicade/bcg-super-star-trek/?interpreter=retrobasic).
