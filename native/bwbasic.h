...
#ifdef INTONLY
typedef long SingleType;
#define   MINSNG                     (  LONG_MIN )
#define   MAXSNG                     (  LONG_MAX )
...
#ifdef INTONLY
typedef long DoubleType;
#define   MINDBL                     (  LONG_MIN )
#define   MAXDBL                     (  LONG_MAX )
#define   DecScanFormat           "%ld%n"
...
struct GlobalStruct
{
  ...
  int IsCheckOnly;                     /* checking-only option on */
  int IsSilent;                        /* "silent" option on */
